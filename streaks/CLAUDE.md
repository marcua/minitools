...
Single-file PWA habit/streak tracker with ayb database backend. Uses the [ayb.js](https://github.com/marcua/ayb) client library for OAuth authentication and database queries.
